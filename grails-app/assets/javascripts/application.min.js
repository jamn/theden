...
});$(document).on("tap","#resetPassword",function(){$(".right-divider").hide();$(".left-divider").show();$("#password-Book").hide();$("#resetPassword").hide();
$("#registerLink").show();$("#showLoginForm").show();$(".new-user").slideUp();$(".errorDetails").slideUp();$("#loginButton").attr("sendPasswordResetEmail",true);
$("#loginButton").attr("attemptPasswordReset",false);$("#loginButton").removeClass("errorButton");$("#loginButton .as-button-label").text("Send Reset Email");
});$(document).on("tap","#showLoginForm",function(){$(".right-divider").hide();$(".left-divider").show();$("#password-Book").show();$("#resetPassword").show();
$("#registerLink").show();$("#showLoginForm").hide();$(".new-user").slideUp();$(".errorDetails").slideUp();$("#loginButton").attr("sendPasswordResetEmail",false);
$("#loginButton").attr("attemptPasswordReset",false);$("#loginButton").removeClass("errorButton");$("#loginButton .as-button-label").text("Book Appointment");
});$(document).on("tap","#loginButton",function(){var a=$(this).attr("disabled");$("#loginButton").removeClass("error-button");if(a!="disabled"){$(this).attr("disabled","disabled");
if($(this).attr("sendPasswordResetEmail")==="true"){sendPasswordResetEmail();}else{if($(this).attr("attemptPasswordReset")==="true"){attemptPasswordReset();
...
});}function bookAppointment(){var d=$("#email").val();var g=$("#email2").val();var c=$("#password-Book").val();var e=$("#firstName").val();var b=$("#lastName").val();
