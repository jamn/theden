...
var b=$("#email").val();var a=$("#password-Cancel").val();$("#cancelAppointmentLoginButton .as-button-label").hide();$("#cancelAppointmentLoginButton .spinner").show();
...
$('.main-content .page[page="'+c+'"]').empty();$('.main-content .page[page="'+c+'"]').slideUp();$('.main-content .page[page="'+a+'"]').append(b);$('.main-content .page[page="'+a+'"]').slideDown();
}