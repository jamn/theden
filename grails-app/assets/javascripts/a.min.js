...
$("#password").keypress(function(c){var a=$("#username").val();var b=$("#password").val();if(c.keyCode===13){window.location.href="../access/login?u="+a+"&p="+b;
...
}else{$("#timeSlotsForRescheduledAppointment-"+c).html(e);}});}$(document).on("tap","#loginButton",function(c){var a=$("#username").val();var b=$("#password").val();
window.location.href="../access/login?u="+a+"&p="+b;});$(document).on("tap",".nav a",function(c){var b=$(this).attr("href");var a=$("body").attr("baseUrl");
...
$("#addClient").fadeIn();}$(document).on("tap",".cancel-appointment-link",function(b){var d=$(this).attr("c");var a=$("body").attr("baseUrl");$.ajax({type:"POST",url:a+"/cancelAppointment",data:{c:d}}).done(function(c){var e=c.search('"success":false');
...
$("#blockOffTimeButton").addClass("errorButton animated fadeIn");}});});$(document).on("tap","#blockOffDaysButton",function(b){var d=$("#fromWholeDay").val();
...
$("#blockOffDaysButton").addClass("errorButton animated fadeIn");}});});$(document).on("tap","#recurringAppointment",function(){if($(this).is(":checked")){$(".recurringAppointmentAdminOptions").fadeIn();
